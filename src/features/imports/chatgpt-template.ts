      ...
      questions: [
        {
          ...
          questionMd:
            "Server Action で DB insert/update する前に何を行うべきか？",
          answerMd:
            "FormData から値を読み取り、Zod schema で検証してから DB を更新する。",
          explanationMd:
      ...
      questions: [
        {
          ...
          questionMd:
            "Server Action で DB を更新した後、関連画面を最新化するために何を呼ぶべきか？",
          answerMd: "`revalidatePath` で関連する path を再検証する。",
          explanationMd:
            "一覧と詳細のように複数画面が同じデータを表示する場合は、必要な path をそれぞれ revalidate する。",
          difficulty: "easy",
          status: "draft",
        },
      ],
